...
metadata {
	definition (name: "HA Heater Temporary Fix", namespace: "fison67", author: "fison67/iquix", ocfDeviceType: "oic.d.thermostat", vid: "generic-thermostat") {
...
def setCoolingSetpoint(temperature){
	sendEvent(name: "coolingSetpoint", value: device.currentValue("heatingSetpoint"), unit: "C", displayed: false)
}
...
def callbackInitialize(physicalgraph.device.HubResponse hubResponse){
    ...
    log.debug "Supported modes are ${supportedModes}"
